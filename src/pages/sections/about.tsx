      ...
      <div className="container my-12 p-4 py-0">
        <div className="flex flex-col">
          ...
          <div className="container flex mb-8">
            <div className="w-1/3">
              <Image priority src="/assets/images/about/pic-2_Square.jpg" alt="Meghan Rabbitt" height={400} width={400}/>
            </div>
          ...
          <div className="container flex mb-8">
            ...
            <div className="w-1/3">
              <Image priority src="/assets/images/about/pic-3_Square.jpg" alt="Meghan Rabbitt" height={400} width={400}/>
            </div>
          </div>

    ...
    <div id="header" className={`container p-4 pt-0`}>
      <div className="flex bg-slate-50">
        ...
        <div className="w-3/5 p-8 flex flex-col justify-center">
          <h1 className="text-5xl mb-6 font-semibold" data-aos="fade-in" data-aos-duration="600">Meghan Rabbitt</h1>
          <span className={styles.line} data-aos="fade-in" data-aos-duration="600"/>
            <div className="text-2xl">
              <TypeSpan>Writer, Editor, Content Strategist</TypeSpan>
            </div>
        </div>
      </div>
    </div>
